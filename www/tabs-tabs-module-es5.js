(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tabs-tabs-module"], {
    ...
    function yR(module, __webpack_exports__, __webpack_require__) {
      ...
      var DataService = /*#__PURE__*/function () {
        function DataService() {
          ...
          this._expense = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](null);
        }
        ...
        _createClass(DataService, [{
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      return _context.abrupt("return", this._expense.getValue());
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      return _context2.abrupt("return", this._expense.next(expenses));
          ...
          key: "getExpensesSubscription",
          value: function getExpensesSubscription() {
    ...
    function cr(module, __webpack_exports__, __webpack_require__) {
      ...
      var _datetime_datetime_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../datetime/datetime.service */
      "KTj7");

      var ActionService = /*#__PURE__*/function () {
        function ActionService(dataService, storageService, dateTimeService) {
        ...
        _createClass(ActionService, [{
              ...
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      key = this.dateTimeService.getDateTimeISO(expense.createdOn);
                      this.storageService.saveExpenseToLocal(expense);
                      return _context3.abrupt("return", this.dataService.setExpenses(expense));
          ...
          key: "getTodayExpensesFromLocal",
          value: function getTodayExpensesFromLocal() {
              ...
              return regeneratorRuntime.wrap(function _callee4$(_context4) {
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      _context4.next = 2;
                      return this.storageService.getExpensesFromLocal().then(function (expenses) {
                        return expenses;
                      });
      ...
      ActionService.ctorParameters = function () {
        return [{
          ...
          type: _datetime_datetime_service__WEBPACK_IMPORTED_MODULE_4__["DatetimeService"]
        }];
      };
    ...
    function E2f4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _datetime_datetime_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../datetime/datetime.service */
      "KTj7");

      var StorageService = /*#__PURE__*/function () {
        function StorageService(dateTimeService) {
        ...
        _createClass(StorageService, [{
          key: "saveExpenseToLocal",
          value: function saveExpenseToLocal(expense) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
              var _this2 = this;

              var key, todaysExpenses;
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      key = this.dateTimeService.getDateTimeISO();
                      todaysExpenses = [];
                      this.getFromLocalStorage(key).then(function (expenses) {
                        if (expenses == null) {
                        ...
                        _this2.saveToLocalStorage(key, todaysExpenses);
                      })["catch"](function (err) {
          ...
          key: "getExpensesFromLocal",
          value: function getExpensesFromLocal(date) {
              ...
              return regeneratorRuntime.wrap(function _callee6$(_context6) {
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    case 0:
                      key = date ? this.dateTimeService.getDateTimeISO(date) : this.dateTimeService.getDateTimeISO();
                      _context6.next = 3;
                      return this.getFromLocalStorage(key).then(function (expenses) {
                        return expenses;
                      });
              ...
              return regeneratorRuntime.wrap(function _callee8$(_context8) {
                while (1) {
                  switch (_context8.prev = _context8.next) {
                    ...
                    case 2:
                      ret = _context8.sent;
                      return _context8.abrupt("return", JSON.parse(ret.value));
              ...
              return regeneratorRuntime.wrap(function _callee9$(_context9) {
                while (1) {
                  switch (_context9.prev = _context9.next) {
                    case 0:
                      _context9.next = 2;
                      return _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Plugins"].Storage.remove({
                        key: key
                      });
      ...
      StorageService.ctorParameters = function () {
        return [{
          type: _datetime_datetime_service__WEBPACK_IMPORTED_MODULE_3__["DatetimeService"]
        }];
      };
    ...
    "KTj7":
    /*!*******************************************************!*\
      !*** ./src/app/services/datetime/datetime.service.ts ***!
      \*******************************************************/

    /*! exports provided: DatetimeService */

    /***/
    function KTj7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var DatetimeService = /*#__PURE__*/function () {
        ...
        _createClass(DatetimeService, [{
          ...
          value: function getCurrentDateTime() {
            return moment__WEBPACK_IMPORTED_MODULE_2__().toDate();
          }
        }, {
          key: "getDateTimeISO",
          value: function getDateTimeISO(date) {
            return date ? moment__WEBPACK_IMPORTED_MODULE_2__(date).format('L') : moment__WEBPACK_IMPORTED_MODULE_2__().format('L');
          }
        }]);
      ...
      DatetimeService.ctorParameters = function () {
        return [];
      };

      DatetimeService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], DatetimeService);
      /***/
    },
    ...
    function U5Cf(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_action_action_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../services/action/action.service */
      "38cr");

      var DashboardComponent = /*#__PURE__*/function () {
        function DashboardComponent(modalController, dataService, actionsService) {
          var _this3 = this;
          ...
          this.expenses = [];
          this.actionsService.getTodayExpensesFromLocal().then(function (value) {
            return _this3.expenses = value;
          });
        }
        ...
        _createClass(DashboardComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.dataService.getExpensesSubscription().subscribe({
              next: function next(expense) {
                console.log(expense);

                if (expense != null) {
                  _this4.expenses.push(expense);
                }
              },
      ...
      DashboardComponent.ctorParameters = function () {
        return [{
          ...
          type: _services_action_action_service__WEBPACK_IMPORTED_MODULE_7__["ActionService"]
        }];
      };
    ...
    function pMVO(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_action_action_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../../../services/action/action.service */
      "38cr");
      /* harmony import */


      var _services_datetime_datetime_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../../services/datetime/datetime.service */
      "KTj7");

      var AddExpenseComponent = /*#__PURE__*/function () {
        function AddExpenseComponent(modalController, actionService, dateTimeService) {
        ...
        _createClass(AddExpenseComponent, [{
          ...
          key: "initCreateExpense",
          value: function initCreateExpense() {
            var _this5 = this;

            var expense = this.addExpenseForm.value;
            expense.createdOn = this.dateTimeService.getCurrentDateTime();
            this.actionService.createExpense(expense).then(function () {
      ...
      AddExpenseComponent.ctorParameters = function () {
        return [{
          ...
          type: _services_action_action_service__WEBPACK_IMPORTED_MODULE_6__["ActionService"]
        }, {
          type: _services_datetime_datetime_service__WEBPACK_IMPORTED_MODULE_7__["DatetimeService"]
        }];
      };
